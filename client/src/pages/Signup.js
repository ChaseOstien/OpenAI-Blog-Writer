  ...
  const handleChange = (e) => {
    ...
    return (
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 className="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-primaryPurple font-robotoRegular">Sign up to Generate Blogs</h2>
      </div>
    
      <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
        <form className="space-y-6 login-form" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="username" className="block text-md font-bold leading-6 text-primaryPurple">Username:</label>
            <div className="mt-2">
          ...
          <div>
            <div className="flex items-center justify-between">
              <label htmlFor="email" className="block text-md font-bold leading-6 text-primaryPurple">Email:</label>
            </div>
            <div className="mt-2">
              <input name="email" type="email" autoComplete="email" value={formData.email} onChange={handleChange} required className="block w-full rounded-lg border-0 py-1 text-primaryPurple bg-mainBackground shadow-sm ring-1 ring-inset ring-primaryPurple pl-2 focus:ring-2 focus:ring-inset focus:ring-primaryVariant sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div>
            <button type="submit" className="flex w-full justify-center rounded-md bg-primaryPurple px-3 py-1 text-md font-semibold leading-6 shadow-sm hover:bg-primaryVariant focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Signup</button>
          </div>
        </form>
